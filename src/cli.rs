use crate::{
    ...
    palace::{
        ...
        establishment::{
            self,
            student::{DeleteIdeaParameters, ListIdeasParameters, NewIdeaParameters},
        },
    },
};
    ...
    match matches.subcommand() {
        ...
        Some(("notebook", arg_matches)) => match arg_matches.subcommand() {
            ...
            Some(("list", arg_matches)) => {
                ...
                let result = establishment::student::list_ideas(ListIdeasParameters {
                    secretary,
                    student: &student,
                })
                .await;
            ...
            Some(("delete", arg_matches)) => {
                ...
                let result = establishment::student::delete_idea(DeleteIdeaParameters {
                    secretary,
                    idea: &Idea::new(&thought, &student).map_err(|err| CliError {
                        description: err.to_string(),
                    })?,
                })
                .await;
                ...
                match result {
                    Ok(_idea) => println!("The thought has been successfully removed."),
                    Err(error) => {
                        return Err(CliError {
                            description: error.to_string(),
                        })
